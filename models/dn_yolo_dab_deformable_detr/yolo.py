...
class YoloBody(nn.Module):
    def __init__(self, phi, output_channels,pretrained=False):
        ...
        #   20, 20, 1024
        #---------------------------------------------------#
        # self.backbone   = YoLo_Backbone(transition_channels, block_channels, n, phi, pretrained=pretrained)
        ...
        self.yolo_head_P3 = nn.Conv2d(transition_channels * 8, output_channels, 1)
        # 40, 40, 512 => 40, 40, 3 * 25 & 85
        self.yolo_head_P4 = nn.Conv2d(transition_channels * 16, output_channels, 1)
        # 20, 20, 512 => 20, 20, 3 * 25 & 85
        self.yolo_head_P5 = nn.Conv2d(transition_channels * 32, output_channels, 1)
